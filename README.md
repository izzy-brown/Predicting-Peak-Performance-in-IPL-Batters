# Predicting-Peak-Performance-in-IPL-Batters
Predicting peak performance in IPL batters using machine learning techniques.
...
'IPL Player Stats - 2016 till 2019.csv' is the data used.

'Predicting_Peaks.R' is my completed R script. 
